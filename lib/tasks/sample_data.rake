...
namespace :db do
  ...
  task add_department: :environment do
    Department.create!(name:                  "Приемная",
                       materially_responsible: "Баров Асфар",
                       phone_number:           Faker::PhoneNumber.subscriber_number(3)
    )

    Department.create!(name:                  "Кредитный отдел",
                       materially_responsible: "Баров Асфар",
                       phone_number:           Faker::PhoneNumber.subscriber_number(3)
    )

    Department.create!(name:                  "Отдел по работе с ЮЛ",
                       materially_responsible: "Баров Асфар",
                       phone_number:           Faker::PhoneNumber.subscriber_number(3)
    )

    Department.create!(name:                  "Отдел по работе с ФЛ",
                       materially_responsible: "Баров Асфар",
                       phone_number:           Faker::PhoneNumber.subscriber_number(3)
    )

    Department.create!(name:                  "Серверная",
                       materially_responsible: "Баров Асфар",
                       phone_number:           Faker::PhoneNumber.subscriber_number(3)
    )
  end
